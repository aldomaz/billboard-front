...
import { Box, Button, CardMedia, Checkbox, Dialog, IconButton, Input, InputBase, InputLabel, Modal, Radio, Typography } from "@mui/material";
...
export const MediaModalContainer = styled(CardMedia)(({theme}) => ({
    height: '40%',
...
export const PrimaryInputLabel = styled(InputLabel)(({theme}) => ({
    marginLeft: '8px',
    fontStyle: 'normal',
    fontWeight: 700,
    fontSize: '20px',
...
export const PrimaryInput = styled(InputBase)(({ theme }) => ({
    width: '100%',
    '& .MuiInputBase-input': {
        borderRadius: '8px',
